...
export function nodeChangeToProps(
  ...
  return {
    ...
    fills: restoreCurvedGradientFills(convertFills(nc.fillPaints), extractPluginData(nc)),
    ...
    effects: restoreAdjustmentEffectStack(convertEffects(nc.effects), extractPluginData(nc)),
