...
export const booleanUnion = defineTool({
  ...
  description:
    'Combine multiple overlapping nodes into a single boolean union node. Returns a summary of the resulting node.',
...
export const booleanSubtract = defineTool({
  ...
  description:
    'Subtract the areas of subsequent nodes from the first node. Returns a summary of the resulting boolean subtract node.',
  execution: { kind: 'sync', mutation: 'document' },
  input: v.object({
...
export const booleanIntersect = defineTool({
  ...
  description:
    'Create a boolean intersect node from the overlapping areas of multiple nodes. Returns a summary of the resulting node.',
  execution: { kind: 'sync', mutation: 'document' },
  input: v.object({
...
export const booleanExclude = defineTool({
  ...
  description:
    'Create a boolean exclude node that removes the overlapping areas of multiple nodes. Returns a summary of the resulting node.',
  execution: { kind: 'sync', mutation: 'document' },
  input: v.object({
