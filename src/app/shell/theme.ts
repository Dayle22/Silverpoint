...
import { activeEditorStore, getActiveEditorStoreOrNull } from '@/app/editor/active-store'
...
const activePageId = computed(() => activeEditorStore.value?.state.currentPageId)

watch([activeEditorStore, activePageId], () => updateCanvasTheme())
...
applyTheme(resolvedTheme.value, normalizeThemeSetting(theme.value))
