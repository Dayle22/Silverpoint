      ...
      <template #rail="{ removeClass }">
        ...
        <Tip v-if="showVisibility" :label="visibilityLabel">
          <PropertyListVisibility
            ...
            class="flex size-control shrink-0 cursor-pointer items-center justify-center rounded-icon border-none bg-transparent p-0 text-muted hover:bg-hover hover:text-surface"
        ...
        <Tip :label="removeLabel">
          <PropertyListRemove
            ...
            :class="[
              removeClass,
              'flex size-control shrink-0 cursor-pointer items-center justify-center rounded-icon border-none bg-transparent p-0 text-muted hover:bg-hover hover:text-surface'
            ]"
