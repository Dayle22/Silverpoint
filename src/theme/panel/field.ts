...
export const panelIconButtonBase =
  'flex size-control shrink-0 cursor-pointer items-center justify-center rounded-icon border border-transparent bg-transparent text-muted outline-none hover:bg-hover hover:text-surface focus-visible:border-panel-focus disabled:cursor-not-allowed disabled:opacity-50'
