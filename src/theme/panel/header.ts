const panelHeaderTheme = {
  slots: {
    ...
    title: 'min-w-0 truncate text-[11px] font-semibold text-surface',
    actions:
      'flex min-w-0 items-center justify-end gap-0.5 [&_[data-slot=icon-button]]:size-control [&_[data-slot=icon-button]]:rounded-icon'
  },
  variants: {
    component: {
      true: {
