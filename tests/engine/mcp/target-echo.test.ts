 ...
 * surfaces the target, not that the desktop app resolves it correctly. The
 * latter still needs the live two-document check recorded in MCP-002.
 */
...
async function connect(sendRpc: RpcSender) {
  ...
  registerTools(server, { enableEval: false, mcpRoot: null, sendRpc })
